...
public enum APIErrorCodes {
    ...
    MASTER_CONFIGURATION_NOT_EXISTS(1033),
    INVALID_MASTER_CONFIGURATION_ID(1034),
    INVALID_ALTERNATE_CONFIGURATION_ID(1035),
    MASTER_CONFIGURATION_NOT_CHANGEABLE(1036);
