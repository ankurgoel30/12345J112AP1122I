...
public class ConfigurationRepositoryTest {
    ...
    public void testFindFirstByCompanyIdAndMasterConfiguration() {
        ...
        Configuration configuration2 = ApiTestDataUtil.createConfiguration(null, 3, "POR", "test config2,1");

        // Saving record into H2 DB
        configurationRepository.save(configuration2);

        Configuration configuration3 = ApiTestDataUtil.createConfiguration(null, 3, "XYZ", "test config3");
