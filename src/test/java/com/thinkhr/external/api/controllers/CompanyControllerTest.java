...
public class CompanyControllerTest {
    ...
    public void testUpdateCompanyWithNoCompanyIdInPath() throws Exception {
        ...
        given(companyController.updateCompany(company.getCompanyId(), companyJson)).willReturn(responseEntity);
    ...
    public void testUpdateCompany() throws Exception {
        ...
        given(companyController.updateCompany(Mockito.any(Integer.class), Mockito.any(String.class)))
